...
|                                | sv_databases     | `gnomad_v2.1_sv.sites.vcf.gz`, `sv_normal.vcf.gz` | Population SV VCF files used to build the SVDB SQLite database. List — add new population databases here. |
